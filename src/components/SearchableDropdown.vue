<template>
  <div class="searchable-dropdown">
    <input type="text" v-model="searchQuery" @input="filterOptions" :placeholder="searchPlaceholder" class="rounded bg-slate-50 pl-3 text-sm" :style="{width: this.dropdownWidth, height:this.dropdownHeight}">
    ...
    <ul v-if="isOpen" class="dropdown-list capitalize text-xxs bg-slate-50">
