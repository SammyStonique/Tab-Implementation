    ...
    setup(){
        ...
        const createTemplate = async() =>{
            ...
            if(errors.value.length){
                ...
                try {
                    const response = await store.dispatch('SMS_Templates/createTemplate', formData);
        ...
        const updateTemplate = async() =>{
            ...
            let formData = {
                ...
                template_type: templateType.value,
                template_content: templateContent.value,
                sms_template: selectedTemplate.value.sms_template_id
            }
            ...
            if(errors.value.length){
                ...
                try {
                    const response = await store.dispatch('SMS_Templates/updateTemplate', formData);
                    if (response && response.status === 200) {
                        hideLoader();
        ...
        return{
            ...
            templateContent, templateName, templateType, editorComponentKey,property_management,member_management,sale_client_management
        }
    }
})
</script>
