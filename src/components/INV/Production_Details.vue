...
export default defineComponent({
    ...
    setup(){
        ...
        const updateFormFields = () =>{
            formFields.value = [
                {
                    type:'search-dropdown', label:"Production Item", value: itemValue.value, componentKey: ledComponentKey,
                ...
                {type:'number', label:"Batch Quantity", value: selectedRecipe.value?.quantity || 0, required: true},
