    ...
    setup(){
        ...
        const updateFormFields = () => {
            formFields.value = [
                ...
                {  
                    type:'search-dropdown', label:"Clients", value: clientValue.value, componentKey: whlComponentKey,
                    ...
                    fetchData: store.dispatch('Asset_Clients/fetchAssetClients', {company:companyID.value}), clearSearch: clearSelectedClient
                },
                ...
                { type: 'text', name: 'client_phone_number',label: "Phone Number", value: selectedReservation.value?.client_phone_number || '0', required: true },
                ...
                { type: 'number', name: 'days_reserved',label: "Reserved Days", value: selectedReservation.value?.days_reserved || '', required: true },
