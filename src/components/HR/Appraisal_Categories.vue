...
export default{
    ...
    setup(){
        ...
        const removingRight = ref('Deleting Appraisal Categories');
        ...
        return{
            title,idField, searchCategories, addButtonLabel, searchFilters, resetFilters, tableColumns, categoryList,handleSelectionChange,
