                    ...
                    <div class="basis-1/2 flex">
                        ...
                        <div class="basis-1/3 mr-6">
                            ...
                            <select v-model="templateType" class="bg-slate-50 rounded border border-gray-400 text-sm pl-2 pt-2 w-full">
                                ...
                                <option value="Leave Request Form">Leave Request Form</option>
                            </select>
                        </div>
                        <div class="basis-1/3">
                ...
                <div class="flex min-h-[550px]">
                    <div class="basis-1/4">
                        <table class="text-left">
                            ...
                            <tr>
                                <td class="font-semibold">Employee Staff No: </td>
                                <td> &#123;&#123; employee_staff_number &#125;&#125;</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="font-semibold">Base Salary: </td>
                                <td> &#123;&#123; employee_base_salary &#125;&#125;</td>
                            </tr>
                            <tr>
                                <td class="font-semibold">Employee Department: </td>
                                <td> &#123;&#123; employee_department &#125;&#125;</td>
                            </tr>
                            <tr>
                                <td class="font-semibold">Employee Supervisor: </td>
                    ...
                    <div class="basis-1/4 pl-6">
                        <table class="text-left">
                            <h2 class="text-center font-bold uppercase mt-4 mb-4">Leave</h2>
                            <tr>
                                <td class="font-semibold">Leave Type: </td>
                                <td> &#123;&#123; leave_type &#125;&#125;</td>
                            </tr>
                            <tr>
                                <td class="font-semibold">Leave Application Date: </td>
                                <td> &#123;&#123; leave_application_date &#125;&#125;</td>
                            </tr>
                            <tr>
                                <td class="font-semibold">Leave Start Date: </td>
                                <td> &#123;&#123; leave_start_date &#125;&#125;</td>
                            </tr>
                            <tr>
                                <td class="font-semibold">Leave End Date: </td>
                                <td> &#123;&#123; leave_end_date &#125;&#125;</td>
                            </tr>
                            <tr>
                                <td class="font-semibold">Leave Reason: </td>
                                <td> &#123;&#123; leave_reason &#125;&#125;</td>
                            </tr>
                            <tr>
                                <td class="font-semibold">Leave Approval Status: </td>
                                <td> &#123;&#123; leave_approval_status &#125;&#125;</td>
                            </tr>
                            <tr>
                                <td class="font-semibold">Approval/Rejection Reason: </td>
