    ...
    setup(){
        ...
        const displayExcelData = () =>{
            ...
            if(excel_file.value == ""){
                ...
                formData.append("share_accounts_excel", excel_file.value) 
        ...
        const importAccountsExcel = () =>{
            ...
            if(!excelAccountsList.value.length){
                ...
                axios.post("api/v1/import-share-accounts-excel/", formData)
                .then((response)=>{
                    if(response.data == "Success"){
                        toast.success("Share Accounts Imported Succesfully")
                        handleReset();
        ...
        const downloadExcelTemplate = () =>{
            ...
            axios.post("api/v1/download-share-accounts-import-excel/", formData, { responseType: 'blob' })
                .then((response)=>{
