...
export default{
    ...
    setup(){
        ...
        const dropdownOptions = ref([
            ...
            {label: 'Post Loan Balance', action: 'post-balance', rightName: 'Posting Loan Balance'},
            {label: 'Unpost Loan Balance', action: 'unpost-balance', rightName: 'Posting Loan Balance'},
