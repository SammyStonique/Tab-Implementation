...
export default{
    ...
    setup(){
        ...
        const addNewProduct = async() =>{
            ...
            await store.dispatch('Loan_Products/updateState', {selectedProduct: null,selectedCategory: null,selectedInterestLedger: null, selectedPenaltyLedger: null,isEditing: false});
