...
export default{
    ...
    setup(){
        ...
        const tableColumns = ref([
            ...
            {label: "Prepayment", key:"formatted_loan_prepayment", type: "number"},
            {label: "Paid Principal", key:"formatted_repaid_principal_amount", type: "number"},
            {label: "Paid Interest", key:"formatted_repaid_interest_amount", type: "number"},
            {label: "Total Payment", key:"formatted_schedule_payment", type: "number"},
